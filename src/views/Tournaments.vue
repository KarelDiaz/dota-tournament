  ...
  <div>
    ...
    <div class="fixed bottom-0 left-0 right-0 top-14">
      <div class="flex flex-col w-full h-full sm:flex-row">
        <!--Tornements-->
        <div class="w-full p-2 pb-0 sm:p-3 sm:h-full sm:w-40 min-h-24">
          <div
          ...
          >
            <!--Tournaments add-->
              ...
              <button
                class="w-full px-4 text-green-900 border border-green-400 rounded-r-lg shadow-md sm:rounded-t-lg bg-gradient-to-b hover:border-green-300 from-green-200 to-green-400 hover:from-green-100 hover:to-green-300"
                @click="modal = true"
              >
