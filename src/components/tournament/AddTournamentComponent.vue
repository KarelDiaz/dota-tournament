          ...
          <div v-for="team in tournamentTemp.teams" :key="team">
            ...
            >
              ...
              <div class="flex flex-col">
                ...
                >
                  <span>{{ p.nick }}</span>
                  <span class="text-xs italic text-green-500">{{ p.mmr }}</span>
                </span>
              </div>
              <!-- Remove team -->
              <button
            ...
            >
              ...
              <div class="flex flex-col space-y-1">
                <transition-group name="slide-top">
                  ...
                  >
                    <i class="absolute text-gray-500 left-1 fa fa-arrow-up"></i>
                    <span>{{ p.nick }}</span>
      ...
      <small v-if="tournamentTemp.type && tournamentTemp.name" class="info">
        <div>
          ...
          <span v-if="tournamentTemp.type.name == ALL_FOR_ALL_1">
            Sera un todos contra todos de un partido definitorio por encuentro.
          </span>
          <span v-if="tournamentTemp.type.name == ALL_FOR_ALL_3">
            Sera un todos contra todos de tres partidos ganar dos por encuentro.
          </span>
